...
export default function CTextInput({iconname  = undefined,Iconcolor='red',IconSize=30,placeholder='',keyboard='',maxL=30,onChangeTextP,onBlur , ...otherprops}) {
  return (
    <View style={styles.container}>
        ...
        <TextInput  editable={false} onBlur={onBlur} onChangeText={onChangeTextP} maxLength={maxL} keyboardType={keyboard} style={styles.textin} placeholder={placeholder} {...otherprops} ></TextInput>
         <MaterialCommunityIcons name={'camera'} color={'black'} size={IconSize} style={{marginLeft:10}}/>
