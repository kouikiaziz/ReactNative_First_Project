 ...
 */
final class Version20240616005423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE friend_requests (id INT AUTO_INCREMENT NOT NULL, id_sender_id INT NOT NULL, INDEX IDX_EC63B01B76110FBA (id_sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE friend_requests_user (friend_requests_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_62AE87C2464C1717 (friend_requests_id), INDEX IDX_62AE87C2A76ED395 (user_id), PRIMARY KEY(friend_requests_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
